<header id="navigation">
	<div id="toolbar">
		<div class="container">
			<div class="row">
				<div class="col-md-6">
					<p class="kill-margin toolbar-slogan">Budapest's Leading Property Services Group</p>
				</div>
				<div class="col-md-6">
					<nav role="navigation">
						<ul class="list-unstyled list-inline text-right kill-margin toolbar-contact">
							<li>
								<span class="hidden-xs">Contact us now on</span>
			...
			<div class="container">
				...
				<div class="collapse navbar-collapse" id="tower-menu">
					<ul class="nav navbar-nav navbar-right">
						...
						<li><a href="landlord.php">Landlord Services</a></li>
						<li><a href="rentals.php">Budapest Rentals</a></li>
						<li><a href="sales.php">Property Sales</a></li>
						<li class="visible-xs"><a href="homes.php">My list of homes</a></li>
