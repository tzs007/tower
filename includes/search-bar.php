		...
		<div class="panel-body">
			<div class="row">
				...
				<div class=" col-sm-5 col-md-6 col-lg-5 col-lg-offset-1 property-search-sort clearfix">
					...
					<div class="property-search-tab property-search-sort-view pull-right hidden-xs">
						<strong class="hidden-sm">List view:</strong>&nbsp;&nbsp;&nbsp;
						<a href="#" class="active" id="property-mosaic-view-switch"><i class="icon-th"></i></a>&nbsp;&nbsp;&nbsp;
						<a href="#" id="property-list-view-switch"><i class="icon-th-list"></i></a>
					</div>
				</div>
			</div>
		</div>
