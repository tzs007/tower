<?php include("includes/head.php") ?>
		...
		<div id="tower-rentals" class="hidden-ie">
			...
			<main id="property-mosaic-view" class="property-list">
				<div class="container">
					<div class="row">
					<?php for($i = 1; $i<=15; $i++): ?>
						<?php include('includes/rental-panel.php') ?>
					<?php endfor; ?>
					</div>
				</div>
			</main>
		...
		<script>
			...
			var places = [
				['pin-green.png', 47.4880756, 18.998205, 'property-details.php'],
				['pin-green.png', 47.54169, 19.005834, 'property-details.php']
			];
		</script>
